...
public class JavaUtilTest {
	...
	public void testGetShortClassNameWithString() {
		...
		assertThat( JavaUtil.getShortClassName( "com.xeomar.xenon.Program" ), is( "c.x.x.Program" ) );
	}
	...
	public void testParseClasspath() throws Exception {
		...
		assertThat( entries.get( 2 ), is( URI.create( "http://www.xeomar.com/software/test3.jar" ) ) );
